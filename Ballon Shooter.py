...
pygame.display.set_caption("Rohit- Balloon Shooter Game")
...
font = pygame.font.SysFont("Ink Free", 25)
...
class Balloon:
    def __init__(self, speed):
        ...
        self.color = random.choice([red, green, purple, orange, yellow, darkBlue])
...
def showScore():
    scoreText = font.render("Antarar Balloons Bursted : " + str(score), True, white)
